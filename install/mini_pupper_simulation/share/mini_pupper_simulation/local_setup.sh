...
: ${AMENT_CURRENT_PREFIX:="/home/user/sfkrobotics_ws/src/install/mini_pupper_simulation"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/mini_pupper_simulation/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/mini_pupper_simulation/environment/path.sh"
