...
**Q: Can I use a joystick/gamepad instead of keyboard?**

A: Yes! Install and use `teleop_twist_joy`:
```bash
sudo apt install ros-humble-teleop-twist-joy
ros2 launch teleop_twist_joy teleop-launch.py
```

**Q: How do I change the world/environment?**

A: Use the `world` argument:
```bash
ros2 launch mini_pupper_simulation main.launch.py \
    world:=/path/to/your/world.world
```

**Q: Can I spawn multiple robots?**

A: Yes, but requires namespace configuration. See advanced tutorials.

**Q: How do I record simulation data?**
